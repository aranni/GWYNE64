...
//============================================================
#define BUFMAP 2								 /**<User select BUFMAP based on application buffer requirements      */
#if BUFMAP > 4
...
#elif BUFMAP == 7
#define EMAC_RX_SZ 512						/**<BUFMAP == 7      */
#define EMAC_TX_SZ 512						/**<BUFMAP == 7      */
#endif
...
// ABR: 17-may-2007 pruebas con tamaño del buffer
#define RX_MAX_FL	        EMAC_RX_SZ     /**< Recieve maxiuim frame length	 */
...
#define SPDLED		 0			/**<If USE_SWLED=1, use software to drive an EPHY speed LED */
#define DUPLED		 0			/**<If USE_SWLED=1, use software to drive an EPHY duplex LED */
#define COLLED		 0			/**<If USE_SWLED=1, use software to drive an EPHY collision LED */
#else							
