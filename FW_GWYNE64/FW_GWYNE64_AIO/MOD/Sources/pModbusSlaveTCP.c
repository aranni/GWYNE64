...
#ifdef  MOD_MODBUSTCP_SLAVE_ENABLED   // Generar aplicación que utiliza MODBUSTCP_SLAVE

#include "pModbusSlaveTCP.h"
#include "Global.h"
#include "system.h"
#include "tcp_ip.h"

///////////////////////////////////////////////////////////////////////////////
// Estados del proceso PROC_MODBUS_SLAVE_TCP
///////////////////////////////////////////////////////////////////////////////
//
const EVENT_FUNCTION	ModbusSlaveTcpProc_IDLE [] =
{
{EVT_TMR_TIMEOUT 	    , f_ModbusSlaveTcpIdleTimeout	    },
{EVT_MODTCP_RXMSG 	  , f_ModbusSlaveTcpIdleAnalizeMsg  },
{EVT_MODTCP_TXMSG 	  , f_ModbusSlaveTcpIdleQueueMsg    },
{EVT_MODRTU_ERR 	    , f_ModbusSlaveTcpIdleErrMsg      },
{EVT_MODTCP_SEND      , f_ModbusSlaveTcpIdleSendMsg     },
//{EVT_MODTCP_CLOSE     , f_ModbusSlaveTcpIdleClose       },			 // deshabilitar momentanemente el tratamiento infomrado de limpieza de buffers, se hace cuando se detecta el canal caido.
...
void f_ModbusSlaveTcpIdleAnalizeMsg (void)
{
  ...
  if (SYS_ConfigParam.DebugLevel>= DBG_LEVEL_2)
  {                    
          		  (void)sprintf((char *)udp_buf,"ModbusSlaveTCP Err:0xA1 \n");
                udp_data_to_send = TRUE;
  }
 #endif  	
               //MON_ResetIfNotConnected(0XA1);    // Error de SW, Reset (TODO: revisar acciones a tomar)
...
//
//-----------------------------------------------------------------------------
// MOD_ModbusSlaveTcpInit : inicializacion de variables del proceso
//-----------------------------------------------------------------------------
//
