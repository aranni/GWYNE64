...
#define MAX_SERIAL_IN_BUFLEN    120   // Capacidad del buffer de entrada de puertos serie
#define MAX_SERIAL_OUT_BUFLEN   100   // Capacidad del buffer de salida de puertos serie
...
typedef enum {
	...
	PROC_MODBUS    		,
	PROC_SERIAL    		,
	PROC_SIEMENS      ,			            // Siemens MicroMaster
	PROC_HITACHI      ,									// Hitachi J300
	PROC_CONFIG       ,
	PROC_RTU          ,
	PROC_MODRTU       ,
	PROC_IIC          ,
	PROC_SIE_MASTERDRV,                 // Siemens MasterDrive
	PROC_HIT_SJ300    ,                 // Hitachi SJ300
	PROC_SIM_SMD      ,                 // Simulador de SieMasterDrive
...
#define FW_VERSION_DEF    "GWY-C-001.700.T"
#define HW_SERIAL_DEF     "B-000000.ENE.08"

//#define TEST_FW_VER_B			 // para reprogramar y tesetear placas version B
#ifdef TEST_FW_VER_B
#define HW_VERSION_DEF    "GWY-B-001.03.06"
#else	  // TEST_FW_VER_B	 
...
// Para compatibilizar con OpenTCP unificado
